...
import { CoffeeDetailService } from './product-detail.service';
...
export class ProductDetailComponent implements OnInit {
  ...
  constructor(
    ...
    if (navigation?.extras?.state) {
      this.calculatedPrice = navigation.extras.state['calculatedPrice'] || 0;
      console.log('Received calculated price:', this.calculatedPrice);
    }
  }
